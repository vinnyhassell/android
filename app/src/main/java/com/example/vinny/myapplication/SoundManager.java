...
/**
 * Created by Vinny on 30/08/2016.
...
public class SoundManager {
    ...
    public static SoundManager create(Context context, int resId) {
        return new SoundManager(context, resId);
    }

    private SoundManager(Context context, int resId) {
        mContext = context;
        mResId = resId;
